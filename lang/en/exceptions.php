...
return [
    'system' => [
        ...
        'http' => [
            ...
            'bad_request' => 'Bad request made to resource: :resource.',
            'gateway_timeout' => 'The server, while acting as a gateway or proxy, did not receive a timely response from the upstream server for resource: :resource.',
            'internal_server_error' => 'The server encountered an internal error while accessing resource: :resource.',
            'method_not_allowed' => 'The HTTP method used is not allowed for resource: :resource.',
            'not_found' => 'The requested resource was not found: :resource.',
            'service_unavailable' => 'The server is currently unavailable to handle requests for resource: :resource.',
            'session_expired' => 'The user session has expired while accessing resource: :resource.',
            'too_many_requests' => 'Too many requests have been made to resource: :resource.',
            'unauthorized' => 'Unauthorized access attempt to resource: :resource.',
            'unprocessable_entity' => 'The server cannot process the request for resource: :resource due to semantic errors.',
        ],
    ],
